...
class NewsPage(Page):
    ...
    category = models.CharField(max_length=100, choices=NEWS_CATEGORY_CHOICES, default="company", verbose_name="Категория")
    headline = models.CharField("Заголовок", max_length=255, default='Заголовок новости')
    ...
    def get_context(self, request):
        ...
        context['other_news'] = NewsPage.objects.live().exclude(id=self.id).order_by('-date')[:3]
        return context
